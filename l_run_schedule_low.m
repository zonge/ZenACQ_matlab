function [ time ] = l_run_schedule_low(obj,file_name,time,delay,duration,SR,GAIN,PERIOD,DUTY)
...
cmd1=['SCHEDULEACTION ' str_start ',y,y,' num2str(PERIOD) ',' num2str(DUTY) ',' num2str(SR) ',' num2str(GAIN) ',0,0,y,n,n,n,' upper(file_name)];
cmd2=['SCHEDULEACTION ' str_end ',y,n,' num2str(PERIOD) ',' num2str(DUTY) ',' num2str(SR) ',' num2str(GAIN) ',0,0,n,n,n,n,ZDONE.Z3D'];
